 ...
 */
	//regrouper les images et les videos dans le meme champ pour faire un seul carrousel
	$field['carrousel'] = array();
	if ($field['type_name'] == 'page_interne' && ($field['field_name'] == 'field_image' || $field['field_name'] == 'field_video')) :
		$field['carrousel'][] = $items;
	endif;
?>
<?php if (!$field_empty) : ?>
